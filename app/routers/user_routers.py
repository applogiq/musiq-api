...
from app.schema.user_schema import FollowerSchema, ResponseSchema, ResponseuserSchema, UserSchema,UserLoginSchema,Refresh_token,UserOptional,UserresponseSchema
...
@router.post("/users/profile-base64/{user_id}")
...
@router.get("/users/{user_id}",response_model=ResponseuserSchema)
...
@router.delete("/users/profile/{user_id}")
